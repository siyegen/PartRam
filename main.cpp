...
// find height of cam, y
GLfloat camHeightY = 20.0f;
GLfloat camDist = camHeightY * sin(glm::radians(45.0f));

// FPSCamera camera(glm::vec3(0.0f, 15.f, camDist));
FPSCamera camera(glm::vec3(0.0f, 5.0f, 10.0f), glm::vec3(0.0f, 1.0f, 0.0f), YAW, -30.0f);
// Used for fps camera
bool keys[1024];
